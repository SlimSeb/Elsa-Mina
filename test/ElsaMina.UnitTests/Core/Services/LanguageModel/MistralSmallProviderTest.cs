...
public class MistralSmallProviderTest
{
    ...
    private MistralSmallProvider _languageModelProvider;
    ...
    public void SetUp()
    {
        ...
        _languageModelProvider = new MistralSmallProvider(_httpService, _configuration);
    }
    ...
    public async Task Test_AskLanguageModelAsync_ShouldCallHttpService_WithCorrectParameters()
    {
        ...
        await _httpService.Received(1).SendAsync<MistralResponseDto>(
            Arg.Is<HttpRequest>(request =>
                ...
                ReadRequestBody(request).Model == "mistral-small-latest" &&
    ...
    public async Task Test_AskLanguageModelAsync_ShouldCallHttpService_WithSystemPromptAndConversation()
    {
        // Arrange
        const string apiKey = "test-api-key";
        const string expectedResponse = "mistral conversation response";
        ...
        await _httpService.Received(1).SendAsync<MistralResponseDto>(
            Arg.Is<HttpRequest>(req =>
                ReadRequestBody(req).Model == "mistral-small-latest" &&
