...
[TestFixture]
public class RandSoupCommandTest
{
    private ISpoonacularService _spoonacularService;
    private IContext _context;
    private RandSoupCommand _command;
    ...
    public void SetUp()
    {
        ...
        _command = new RandSoupCommand(_spoonacularService);
    }
    ...
    [Test]
    public void Test_HelpMessageKey_ShouldBeRandSoupHelp()
    {
        // Arrange
        // (no additional setup)
        ...
        // Assert
        Assert.That(key, Is.EqualTo("randsoup_help"));
    }

    [Test]
    public async Task Test_RunAsync_ShouldCallServiceWithSoupTag()
    {
        // Arrange
        ...
        // Assert
        await _spoonacularService.Received(1).GetRandomRecipeHtmlAsync("soup", Arg.Any<CancellationToken>());
    }
