...
[TestFixture]
public class RandCheeseCommandTest
{
    private ISpoonacularService _spoonacularService;
    private IContext _context;
    private RandCheeseCommand _command;
    ...
    public void SetUp()
    {
        ...
        _command = new RandCheeseCommand(_spoonacularService);
    }
    ...
    [Test]
    public void Test_HelpMessageKey_ShouldBeRandCheeseHelp()
    {
        // Arrange
        // (no additional setup)
        ...
        // Assert
        Assert.That(key, Is.EqualTo("randcheese_help"));
    }

    [Test]
    public async Task Test_RunAsync_ShouldCallServiceWithCheeseTag()
    {
        // Arrange
        ...
        // Assert
        await _spoonacularService.Received(1).GetRandomRecipeHtmlAsync("cheese", Arg.Any<CancellationToken>());
    }
