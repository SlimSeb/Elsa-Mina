...
[TestFixture]
public class EditShopCommandTest
{
    private IShopService _shopService;
    private ITemplatesManager _templatesManager;
    private IConfiguration _configuration;
    private IContext _context;
    private EditShopCommand _command;
    ...
    public void SetUp()
    {
        ...
        _command = new EditShopCommand(_shopService, _templatesManager, _configuration);
    }
    ...
    [Test]
    public void Test_HelpMessageKey_ShouldBeShopEditHelp()
    {
        Assert.That(_command.HelpMessageKey, Is.EqualTo("shop_edit_help"));
    }
    ...
    [Test]
    public async Task Test_RunAsync_ShouldRenderShopEditPanelTemplate_WhenExecuted()
    {
        // Arrange
    ...
    [Test]
    public async Task Test_RunAsync_ShouldReplyHtmlPage_WithShopEditKey()
    {
        // Act
        await _command.RunAsync(_context);

        // Assert
        _context.Received(1).ReplyHtmlPage("shop-edit", Arg.Any<string>());
    }
