...
public class RoomUserDataService : IRoomUserDataService
{
    ...
    public async Task SetUserEmojiAsync(
        string roomId,
        string userId,
        string emoji,
        CancellationToken cancellationToken = default)
    ...
    public async Task SetUserBackgroundColorAsync(
        string roomId,
        string userId,
        string color,
        CancellationToken cancellationToken = default)
    {
        ...
        user.ProfileBackgroundColor = color;
        dbContext.RoomUsers.Update(user);

        await dbContext.SaveChangesAsync(cancellationToken);
    }

    public async Task SetUserTextColorAsync(
        string roomId,
        string userId,
        string color,
        CancellationToken cancellationToken = default)
